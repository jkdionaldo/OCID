...
const CEGSUndergrad = () => {
  ...
  const programs = [
    ...
    },
    {
      ...
      careers: ["Geologist", "Environmental Geologist", "Mining Geologist", "Petroleum Geologist", "Hydrogeologist"],
      syllabusFiles: {
    ...
    },
    {
      ...
      careers: ["Geodetic Engineer", "Land Surveyor", "GIS Specialist", "Remote Sensing Analyst", "Cartographer"],
      syllabusFiles: {
        ...
        <div className="container mx-auto px-4 py-8">
          <div className="flex flex-col items-center text-center relative">
            ...
            <div className="w-24 h-24 bg-white rounded-full p-1 flex-shrink-0 mb-6 shadow-lg">
              <img src="/images/cegs-logo.png" alt="CEGS Logo" className="w-full h-full object-contain" />
            </div>
            ...
            <div className="p-6 border-b bg-gradient-to-r from-orange-50 to-white">
              <div className="flex justify-between items-center">
                ...
                <div className="text-center flex-1">
                  <h3 className="text-2xl font-bold text-orange-700">{programsState[selectedProgram].name}</h3>
                    ...
                    {programsState[selectedProgram].programEducationalObjectives?.map((objective, index) => (
                      <div key={index} className="bg-gray-50 p-4 rounded-lg border-l-4 border-orange-500">
                        <p className="text-gray-700">
                          <span className="font-semibold text-orange-700">Objective {index + 1}:</span> {objective}
                        </p>
                      </div>
                    ))}
                  </div>
                ...
                <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
                  ...
                  <div className="space-y-3">
                    {programsState[selectedProgram].programOutcomes.map((outcome, index) => (
                      <div key={index} className="bg-gray-50 p-4 rounded-lg border-l-4 border-orange-500">
                        <p className="text-gray-700">
                          <span className="font-semibold text-orange-700">Outcome {index + 1}:</span> {outcome}
                        </p>
                      </div>
                    ))}
                  </div>
