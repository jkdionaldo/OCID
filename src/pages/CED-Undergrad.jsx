      ...
      <div className="bg-gradient-to-r from-blue-700 to-blue-900 text-white py-8 md:py-12 relative">
        ...
        <div className="container mx-auto px-4 py-6 md:py-8">
          <div className="flex flex-col items-center text-center relative">
            ...
            <h1 className="text-2xl md:text-3xl lg:text-4xl font-bold mb-2 md:mb-4">College of Education</h1>
      ...
      {showSyllabusUpload && selectedProgram !== null && (
        <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4 backdrop-blur-sm">
          <div className="bg-white rounded-xl max-w-md w-full shadow-2xl">
            <div className="p-6">
              <div className="flex justify-between items-center mb-6">
                <h3 className="text-xl font-bold text-blue-700">Upload Syllables File</h3>
                <button
