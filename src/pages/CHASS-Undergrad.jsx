            ...
            <div className="p-6 border-b bg-gradient-to-r from-purple-50 to-white">
              <div className="flex justify-between items-center">
                ...
                <div className="text-center flex-1">
                  <h3 className="text-2xl font-bold text-purple-700">{programsState[selectedProgram].name}</h3>
                    ...
                    {programsState[selectedProgram].programEducationalObjectives?.map((objective, index) => (
                      <div key={index} className="bg-gray-50 p-4 rounded-lg border-l-4 border-purple-500">
                        <p className="text-gray-700">
                          <span className="font-semibold text-purple-700">Objective {index + 1}:</span> {objective}
                        </p>
                      </div>
                    ))}
                  </div>
                ...
                <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
                  ...
                  <div className="space-y-3">
                    {programsState[selectedProgram].programOutcomes.map((outcome, index) => (
                      <div key={index} className="bg-gray-50 p-4 rounded-lg border-l-4 border-purple-500">
                        <p className="text-gray-700">
                          <span className="font-semibold text-purple-700">Outcome {index + 1}:</span> {outcome}
                        </p>
                      </div>
                    ))}
                  </div>
