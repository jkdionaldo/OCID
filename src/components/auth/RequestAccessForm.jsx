const RequestAccessForm = ({ onBack }) => (
  <div className="w-full max-w-xs mx-auto py-10">
    ...
    <button
      type="button"
      onClick={onBack}
      className="mt-12 w-full py-2 px-4 border border-transparent rounded-lg shadow-sm text-sm font-medium text-white bg-gradient-to-r from-green-600 to-green-700 hover:from-green-700 hover:to-green-800 focues:outline=none focus:ring-2 focus:ring-offset-2 focus:ring-green-500"
    >
      {" "}
      Back to Login
    </button>
