  ...
  return (
    <div className="flex justify-center">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl w-full">
        ...
        <Card className="group relative overflow-hidden rounded-xl shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-200">
          ...
          <CardContent className="p-6 relative z-10">
            <div className="flex items-center justify-between">
              ...
              <FileText className="h-10 w-10 text-purple-500 group-hover:text-purple-600 transition-colors duration-300" />
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="group relative overflow-hidden rounded-xl shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-200">
          ...
          <CardContent className="p-6 relative z-10">
            <div className="flex items-center justify-between">
              ...
              <Files className="h-10 w-10 text-indigo-500 group-hover:text-indigo-600 transition-colors duration-300" />
            </div>
          </CardContent>
        </Card>
        ...
        {/* Total Downloads */}
        <Card className="group relative overflow-hidden rounded-xl shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-200">
          <div className="absolute inset-0 bg-gradient-to-br from-teal-400 to-teal-600 opacity-10 group-hover:opacity-20 transition-opacity duration-300"></div>
          <CardContent className="p-6 relative z-10">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-gray-600">
                ...
                <p className="text-3xl font-extrabold text-gray-900 group-hover:text-teal-600 transition-colors duration-300">
                  {stats.downloads || 0}
                </p>
              </div>
              <Download className="h-10 w-10 text-teal-500 group-hover:text-teal-600 transition-colors duration-300" />
            </div>
          </CardContent>
        </Card>
      </div>
